package com.mytest.register.enums;

/**
 * @author gdufeZLYL
 * @date 2019/9/14 11:44
 */
public enum Status {
    ...
    USER_PHONE_EXIST(10142, "user phone already exists"),
    USER_NAME_OR_PASSWORD_OR_PHONE_EMPTY(10142, "user name, password and phone is not empty"),
